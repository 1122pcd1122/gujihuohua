...
const enterSystem = () => { showWelcome.value = false }

const handleViewChange = (view) => {
  activeView.value = view
  if (view === 'library') {
    nextTick(() => libraryRef.value?.fetchList())
  }
}
// ... saveRecord 逻辑不变 ...
  ...
  <div class="app-root">
    ...
    <div class="app-container" v-if="!showWelcome">
      ...
      <div class="main-content">
        <keep-alive>
          <TextProcess v-if="activeView === 'process'" @save-record="handleSaveRecord" />
          <TextLibrary v-else-if="activeView === 'library'" ref="libraryRef" />
...
<style>
body, html { margin: 0; padding: 0; width: 100%; height: 100%; font-family: "KaiTi", serif; background-color: #fcf9f2; overflow: hidden; }
</style>
